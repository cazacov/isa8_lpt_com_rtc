...
```
                                    ISA 8-bit Bus (edge connector)
===============================================================================
| D0-D7         IOR#  IOW#     A0-A2        A3-A9         AEN                 |
===============================================================================
    ^             |     |         |            |            |
    |             |     |         |            |            |
    |             |     |         |            |            |
    v             v     v         v            v            v
+------------+    |     |         |      +----------------------------------------------+     +----------------------------+
| 74HCT245   |    |     |         |      |            ATF22V10                          |     |    Address Jumpers         |
|            |    |     |         |      |                                              |     |----------------------------|
| Side A     |    |     |         +----->|                                              |     | J1: 0x3F8/0x2F8 (COM1)    |
|            |    |     |         |      |                                              |<----+ J3: 0x3E8/0x2E8 (COM2)    |
|            |    |     +--------------->|                                              |     | J5: 0x378/0x278 (PRN)     |
|            |    |               |      |                                              |     +----------------------------+
|            |<---+--------------------->|                                              |
...
+------------+                    |      +----------------------------------------------+
    ^                             |          |            |            |            |
    |                             |          v            v            v            v
    |                             |     RTC signals    COM1_CS#     COM2_CS#     PRN_CS# 
    |                             |
    |   (buffered D0-D7)    A0-A2 (to devices)
    |
    +--- (continues to devices below...)
```
